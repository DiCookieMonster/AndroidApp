...
import com.example.user.juneyipuser.Order.showOrderPicked;
...
public abstract class hmOrderListFragment extends Fragment {
            ...
            protected void populateViewHolder(final OrderViewHolder viewHolder, final Order model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(getActivity(), showOrderPicked.class);
                        intent.putExtra(showOrderPicked.EXTRA_POST_KEY, postKey);
