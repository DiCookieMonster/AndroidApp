...
import com.example.user.juneyipuser.Order.showOrderFinishedHm;
...
public abstract class hmClosedOrdersListFragment extends Fragment {
    ...
    public hmClosedOrdersListFragment() {}
            ...
            protected void populateViewHolder(final OrderViewHolder viewHolder, final Order model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(getActivity(), showOrderFinishedHm.class);
                        intent.putExtra(showOrderFinishedHm.EXTRA_POST_KEY, postKey);
