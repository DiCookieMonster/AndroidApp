...
import com.example.user.juneyipuser.Order.showOrderSumUser;
...
public abstract class userClosedOrdersListFragment extends Fragment {
    ...
    public userClosedOrdersListFragment() {}
            ...
            protected void populateViewHolder(final OrderViewHolder viewHolder, final Order model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(getActivity(), showOrderSumUser.class);
                        intent.putExtra(showOrderSumUser.EXTRA_POST_KEY, postKey);
